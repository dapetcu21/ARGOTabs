...
OpenController = require './opencontroller'
AlertController = require './alertcontroller'
Extensions = require './extensions'
Tournament = require '../models/tournament'
Backend = require '../models/backend'
JSONSource = require '../models/backends/jsonsource'
Util = require './util'
$ = require 'jquery'

templateSaveAs = require './templates/saveAs.jade'
templateAlert = require './templates/alert.jade'
