...
templateDisclaimer = require './templates/disclaimer.jade'
templateOpenModal = require './templates/openModal.jade'
templateOpenModalAddLocal = require './templates/openModalAddLocal.jade'
templateOpenModalAddItem = require './templates/openModalAddItem.jade'
...
class OpenController
  constructor: (@uiController, onReady = (->), onDismiss = (->)) ->
    ...
    openModal.find('#omodal-btn-new').click =>
      newNode = $('#omodal-add-page3').html templateOpenModalAddLocal
  ...
  addItem: (source) ->
    ...
    itemNode = $(templateOpenModalAddItem item)
